...
# Install Apps
        ...
        sudo dnf install sassc gtk-murrine-engine gtk2-engines picom ulauncher code transmission-cli code xfce4-docklike-plugin openssl mpv lightdm-gtk-greeter-settings -y &&
...
# Setup Qogir Theme
        ...
        sudo sh $HOME/fedora-xfce-setup/Qogir-theme/install.sh -d /usr/share/themes -c standard light dark &&
        sudo sh $HOME/fedora-xfce-setup/Qogir-icon-theme/install.sh -d /usr/share/icons &&
