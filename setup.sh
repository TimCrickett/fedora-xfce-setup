...
# Install Apps
        ...
        sudo dnf install -y sassc fzf gtk-murrine-engine gtk2-engines picom ulauncher code transmission-cli code xfce4-docklike-plugin openssl mpv lightdm-gtk-greeter-settings &&
...
# Setup Ani-CLI
	...
	sudo mv $HOME/Downloads/ani-cli-master/ani-cli /usr/local/bin &&
